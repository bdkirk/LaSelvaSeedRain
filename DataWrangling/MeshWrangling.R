...
#bring in datafile
mesh_abund <- read.csv("yearsub_no_trtsp_nw.csv")
...
#bring in data
meshdiv <- read.csv("yearsub_no_trtsp_nw.csv")
...
meshdiv_data2 <- cbind(x, y[,122:125])
tail(meshdiv_data2)
...
######### Composition ########
#bring in data
meshcomp <- read.csv("yearsub_no_trtsp_nw.csv")
...
#### Phenology ####
#bring in data file
mesh_pheno <- read.csv("seedrain_all_tidy_nw.csv")
